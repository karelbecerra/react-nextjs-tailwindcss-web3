...
const Logo = React.forwardRef(({size, color, onClick, href}, ref) => {
  return (
    <a href={href} onClick={onClick}  ref={ref}>
      <svg className={classNames( size + " mr-1 " + (color == undefined? "text-swc-right" : color))} x="0px" y="0px" viewBox="0 0 489.8 489.8">
		        <path stroke="currentColor" fill="currentColor" d="M438.2,0H51.6C23.1,0,0,23.2,0,51.6v386.6c0,28.5,23.2,51.6,51.6,51.6h386.6c28.5,0,51.6-23.2,51.6-51.6V51.6    C489.8,23.2,466.6,0,438.2,0z M465.3,438.2c0,14.9-12.2,27.1-27.1,27.1H51.6c-14.9,0-27.1-12.2-27.1-27.1V51.6    c0-14.9,12.2-27.1,27.1-27.1h386.6c14.9,0,27.1,12.2,27.1,27.1V438.2z"/>
